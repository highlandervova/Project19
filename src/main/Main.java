        ...
        parser.parse(xmlDocument, new DefaultHandler() {
            ...
            public void startElement(String s, String s1, String tagName, Attributes attributes) throws SAXException {
                switch (tagName) {
                    ...
                    case "department":
                        ...
                        idId=Integer.valueOf(attributes.getValue("id"));
            ...
            public void endElement(String s, String s1, String tagName) throws SAXException {
                switch (tagName) {
                    ...
                    case "departments":
                        System.out.println("Number of employees with id=1: "+numEmpl);
                        break;
                }
            }
            ...
            public void characters(char[] chars, int start, int length) throws SAXException {
                ...
                if(idDep==2&&idId==2){
                    System.out.println("Employee in Department 2 and Name with id=2: "+emp.getName());
                }
                }
            }
        });
